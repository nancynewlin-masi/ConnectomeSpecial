...
echo "Run: $run_part"
echo "Working path: ${workingpath_accre}"

mkdir ${workingpath_accre}
mkdir ${workingpath_accre}/Slant
mkdir ${workingpath_accre}/PreQual
...
scp -r ${myuser}@hickory.accre.vanderbilt.edu:${workingpath_accre}/Output/ ${myuser}@hickory.accre.vanderbilt.edu:${rawoutput_nfs}/${id}/
